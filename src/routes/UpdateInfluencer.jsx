...
function UpdateInfluencer() {
  ...
  return (
    <main className='influencer-container'>
      <h1 className='influencer-title'>인플루언서 정보 수정</h1>
      ...
      <section className='influencer-fields'>
        ...
        <div className='influencer-field'>
          ...
          <input
            ...
            type='number'
            min={0}
            value={myInfluencer.subscribers}
      ...
      <button onClick={handleUpdateInfluencer} className='register-btn'>
        수정 완료
      </button>
    </main>
  );

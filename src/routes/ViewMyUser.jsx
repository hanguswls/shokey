    ...
    <div className="user-container">
      ...
      <div className="user-fields">
        <div className="user-field">
          ...
          <span className="user-field-value">{myUser.userId}</span>
        </div>
        <div className="user-field">
          <span className="user-field-name">이름</span>
          <span className="user-field-value">{myUser.userName}</span>
        </div>
        <div className="user-field">
          <span className="user-field-name">성별</span>
          <span className="user-field-value">{myUser.userGender ? '남성' : '여성'}</span>
        </div>
        <div className="user-field">
          <span className="user-field-name">이메일</span>
          <span className="user-field-value">{myUser.userEmail}</span>
        </div>
        <div className="user-field">
          <span className="user-field-name">인플루언서 여부</span>
          <span className="user-field-value">{myUser.userRole ? '인플루언서' : '일반 사용자'}</span>
        </div>
      </div>
